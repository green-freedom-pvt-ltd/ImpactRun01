...
var _jsxFileName = 'src/BarChart.js';
...
var
    BarChart = function(_Component) {
        ...
        function BarChart(props) {
            ...
            _this.
            _drawBar = function(_dataPoint, index) {
                var _dataPoint2 = _slicedToArray(
                    _dataPoint, 2);
                var _x = _dataPoint2[0];
                var dataPoint = _dataPoint2[1];
                var backgroundColor = "#0077ff";
                var HEIGHT = _this.props.height + 19;
                ...
                var theight = maxBound / 100;
                var bheight = HEIGHT / maxBound;
                var heightbar = (dataPoint === undefined) ? bheight * 0 : (bheight * dataPoint) / 1.2;
                var height = HEIGHT - (minBound * scale + (HEIGHT - dataPoint * scale));
                data.forEach(function(item) {
                    if (item[1] == undefined) {
                        arrayDatapoint.push(0)
                    } else {
                        arrayDatapoint.push(item[1])
                    }
                });
                var datapoint0 = (dataPoint === undefined) ? 0 : dataPoint;
                renderIcon = function(dataPoint) {
                }
                var max = arrayDatapoint.reduce(function(a, b) {
                    return Math.max(a, b);
                });
                var maxdataPoint = Math.max.apply(Math, );
                    ...
                    _react2.default.createElement(_reactNative.TouchableWithoutFeedback, {
                        ...
                        _react2.default.createElement(_reactNative.View, {
                            ...
                            _react2.default.createElement(_reactNative.Text, {
                                ...
                                style: {
                                    color: '#6a6a6a',
                                    fontSize: styleConfig.barChatFontSize,
                                    textAlign: 'center',
                                    backgroundColor: 'transparent',
                                },
                                name: 'inr'
