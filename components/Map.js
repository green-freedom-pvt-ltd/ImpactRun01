...
var Map = React.createClass({
  ...
  getInitialState() {
    ...
    SettingsService.getValues(function(values) {
      values.url = 'http://92.168.1.25:8080';
  ...
  render: function() {
    ...
    return (
      <View style={styles.container}>  
       <Icon.Button name="ios-options" onPress={this.onClickMenu} backgroundColor="transparent" size={30} color="white" style={styles.btnMenu} underlayColor={"transparent"} />      
        <View style={styles.map}> <Mapbox
            style={styles.map}
            direction={0}
            rotateEnabled={true}
            scrollEnabled={true}
            ...
            onUpdateUserLocation={this.onUpdateUserLocation} /></View>
