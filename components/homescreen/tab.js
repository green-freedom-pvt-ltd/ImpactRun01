            ...
            <View style={{flex:1}}>     
              <TabBarIOS 
                ...
                <TabBarIOS.Item
                  ...
                  <View>
                    <Homescreen myCauseCount={this.props.dataCauseCount} fetchDataonInternet ={this.fetchDataonInternet} user={this.state.user} getUserData={this.getUserData} myCauseNum={this.state.dataCauseNum} navigator={this.props.navigator}/>                    
                 </View>
                </TabBarIOS.Item>
